...
if __name__ == '__main__':
    ...
    train_model.compile(optimizer=Adam(lr=0.0001),
    ...
    def train_generator(x, y, batch_size):
        ...
        generator = train_datagen.flow(x, y, batch_size=batch_size) #, save_to_dir='/home/sascha/tmp/TinyImgnt')
    ...
    lr_reduce = callbacks.ReduceLROnPlateau(factor=0.9, monitor='val_loss', mode='min', verbose=1, patience=5)
