...
from anysma.modules.measuring import OmegaDistance, MinkowskiDistance, TangentDistance
...
diss = TangentDistance(linear_factor=None,
                       ...
                       prototype_constraint= None)#lambda x: K.clip(x, 0., 1.))
caps = Capsule(prototype_distribution=(10, 10))
